...
const Simulator = () => {
    ...
    return (
      <div className="m-10 text-white">
        <h1 className="m-2 text-white mb-5"> Préstamo </h1>
        <div>
            <div className="w-full flex flex-row space-x-5 justify-center">
                <p className="m-5">¿Cuánto necesitas?</p>
                <p className="m-5 text-cyan-500">$1000</p>
            </div>

            <div class="relative mb-6 ml-5 mr-5" >
            ...
            <div className="w-full mt-20 flex flex-row space-x-5 justify-center">
                <p>¿En cuántos días lo deseas devolver?</p>
                <p class="text-cyan-500">30 días</p>
            </div>
            <div class="relative mb-6 m-5 text-white mb-20" >
                <label for="labels-range-input" class="sr-only">Labels range</label>
        ...
        <h1 className="text-white mb-10">Resumen</h1>
